...
class IncrementalEncoder:
    def __init__(self, pin_a, pin_b=None, divisor=1, counts_per_rev=48 * 4.4 * 38 / 13, gear_ratio=1.0, wheel_diameter_mm=62.4):
        ...
        counts_per_rev is the full x4 resolution per WHEEL revolution:
            48 counts/motor-rev (Pololu 4861, 48 CPR encoder)
            * 4.4  internal gearbox reduction (4.4:1 metal spur gearbox)
            * 38/13 external gear reduction (13T motor -> 38T wheel)
            = 617.35 counts per wheel revolution.
